...
export default function CatSprite({ x = 0, y = 0, angle = 0, message = "" }) {
  return (
    <div
      style={{
        position: "absolute",
    ...
    >
      {message && (
        <div className="text-red-600 font-bold text-sm mb-1 bg-white bg-opacity-80 px-2 py-1 rounded shadow">
          {message}
        </div>
      )}
      ...
      <svg
        ...
        width="95.18"
        height="100.04"
        viewBox="0.321 0.3 95.179 100.042"
        version="1.1"
        xmlSpace="preserve"
        style={{
          pointerEvents: "none",
